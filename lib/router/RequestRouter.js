...
const formatterHelper = require('../helpers/formatters');
...
class RequestRouter {
  ...
  constructor(locator) {
    ...
    const data = formatterHelper.mergeFormatters();
  ...
  requestListener(request, response) {
    ...
    response.acceptable = this.acceptable;
    response.formatters = this.formatters;
    ...
    return Promise.resolve()
      ...
      .then(data => {
        const formatter = response.getFormatter();
