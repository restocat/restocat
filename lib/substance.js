 ...
 * Ресурс
 *
 * Добавляет в субстанцию ресурс с указанной схемой и опциями
 * или возвращает по имени
 *
 * После того, как модель была сгенерирована и добавлена, вызывается
 * роутер, для создания обработчиков запросов
 *
 * @param {String}        name    Имя ресурса (в ед. числе)
 * @param {Object|Schema} schema  Схема добавляемого ресурса
 * @param {Object}        options Дополнительные опции для установки в схему
 * @return {this}
 */
//Substance.prototype.resource = ;
