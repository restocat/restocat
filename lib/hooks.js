...
module.exports = function( model ){
  ...
  return {
    ...
    validateAndSetDefaultMongooseParams: function (req, res, next) {
      ...
      req.checkQuery('skip', 'Invalid filters. Param must be is number').optional().isNumeric();
      req.checkQuery('sort', 'Invalid filters. Param must be is object or string').optional().isObjectOrString();
      req.checkQuery('populate', 'Invalid filters. Param must be is object or string').optional().isObjectOrString();
      req.checkQuery('transform', 'Invalid filters. Param must be is boolean').optional().isBoolean();
